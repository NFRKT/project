...
public class ReportDAO {
	...
	public List<Report> getList(Map<String, Object> searchParams, String a) {
		List<Report> list = null;
		...
		String where = "";
		String orderby = "order by r.idReport asc";

		// search for surname
		String idReport = (String) searchParams.get("idReport");
		if (idReport != null) {
			if (where.isEmpty()) {
				where = "where ";
			} else {
			...
			where += "r.idReport like :idReport ";
		}
